...
<tr>
    ...
    <?php $query=mysqli_query($con,"select * from tblfirereport where status='Request Completed' AND Service='Fire' ");
    $cnt=1;
...
<tr>
        ...
        <a href="../view/request-details.php?requestid=<?php echo $row['id'];?>">View</a> 
