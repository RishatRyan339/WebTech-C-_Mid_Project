...
<?php $query=mysqli_query($con,"select * from tblfirereport where status='Fire Relief Work in Progress' AND Service='Fire'");
$cnt=1;
...
<tr>
                ...
                <a href="request-details2.php?requestid=<?php echo $row['id'];?>">View</a> 
